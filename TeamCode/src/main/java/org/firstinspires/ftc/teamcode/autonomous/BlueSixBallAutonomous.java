...
import org.firstinspires.ftc.teamcode.autonomous.paths.RandomPath;
...
public class BlueSixBallAutonomous extends CommandOpMode {
    ...
    public void initialize() {
        ...
        currentPathChain = RandomPath.path(drivetrain.follower);
