...
@Autonomous(name="MultiCloseLeave", group="SimpleAutonomous")
public class MultiCloseLeaveAutonomous extends CommandOpMode {
    ...
    public void initialize() {
        ...
        drivetrain.follower.setStartingPose(new Pose(56, 136, Math.toRadians(90)));
