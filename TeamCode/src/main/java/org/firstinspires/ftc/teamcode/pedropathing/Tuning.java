...
public class Tuning extends SelectableOpMode {
    ...
    public static void drawOnlyCurrent() {
        try {
            Drawing.drawRobot(follower.getPose(), "Orange");
            Drawing.sendPacket();
        } catch (Exception e) {
...
class LocalizationTest extends OpMode {
    ...
    public void init_loop() {
        telemetryA.addLine("This will print your robot's position to telemetry while " + "allowing robot control through a basic mecanum drive on gamepad 1.");
        telemetryA.update();
        follower.update();
        drawOnlyCurrent();
    }
...
class LateralTuner extends OpMode {
    ...
    @Override
    public void init_loop() {
        telemetryA.addLine("Pull your robot to the left " + DISTANCE + " inches. Your strafe ticks to inches will be shown on the telemetry.");
        telemetryA.update();
        drawOnlyCurrent();
    }
